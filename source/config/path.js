 ...
 * @type String
 */
Path.dest.serverFiles   = Path.base + '/statics';
...
Path.dest.third_party_libs = Path.dest.serverFiles + Path.dest.static + '/js/thirdPartyLibs';
